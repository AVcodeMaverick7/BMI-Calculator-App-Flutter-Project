...
class BMICalculator {
  ...
  Image getImage() {
    if (_bmi >= 30) {
      return Image.asset('images/obese.png', fit: BoxFit.contain);
    } else if (_bmi >= 25 && _bmi < 30) {
      return Image.asset('images/overweight.png', fit: BoxFit.contain);
    } else if (_bmi > 18.5 && _bmi < 25) {
      return Image.asset('images/normal.png', fit: BoxFit.contain);
    } else {
      return Image.asset('images/underweight.png', fit: BoxFit.contain);
    }
  }
